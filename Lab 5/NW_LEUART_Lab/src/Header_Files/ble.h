...
#define HM10_RXENABLE 		true;
#define HM10_TXENABLE		true;

#define LEUART0_TX_ROUTE	LEUART_ROUTELOC0_RXLOC_LOC18   	// Route to ...
#define LEUART0_RX_ROUTE	LEUART_ROUTELOC0_TXLOC_LOC18   	// Route to ...
